...
3. Ujistěte se, že máte stažený modul Pygame-ce (ideálně verzy 2.5.7). Jeden možný způsob jak to udělat je napsáním "pip show pygame-ce"  
    do příkazové řádky. Pokud Pygame-ce stažený nemáte jak si ho stáhnout naleznete [zde](https://github.com/pygame-community/pygame-ce#readme)  
---  
1. Clone the repository
2. Check if Python is installed (ideally version 1.13.7). This can be checked by writing "python -V" into the command line.  
    If not install Python. How to do so can be found for example [here](https://www.python.org/downloads/)  
...
2. Do příkazové řádky napište "python Nadpiškvorky.py"  
---  
0. (voluntary) Read the rules of the game in the text file "rules_en.txt"  
1. Find the adress of "Nadpiškvorky.py", open a command line and have the active directory be where "Nadpiškvorky.py" is  
2. Write "python Nadpiškvorky.py" into the command line  
